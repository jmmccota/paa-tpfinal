...
public class Save {
	...
	public void saveOthers(int access, int cliqueSize, int lowerBound, Graph g) {
		float degree = 0;
		for (int i = 0; i < g.n; i++)
		...
		try {
			...
			print.printf("Lower Bound: " + lowerBound + "\r\n");
	...
	public void saveOthers(int access, int cliqueSize, int lowerBound, int upperBound, Graph g) {
		float degree = 0;
		for (int i = 0; i < g.n; i++)
			degree += g.vertex.get(i).degree;
		degree /= g.n;
		...
		try {
			...
			print.printf("Clique Size: " + cliqueSize + "\r\n");
			print.printf("Lower Bound: " + lowerBound + "\r\n");
			print.printf("Upper Bound: " + lowerBound + "\r\n");
			print.printf("Average Degree: " + degree + "\r\n");
	...
	public void saveOthers(int access, int cliqueSize, Graph g) {
		...
		try {
			...
			print.printf("Access: " + access + "\r\r\n");
			print.printf("Clique Size: " + cliqueSize + "\r\r\n");
			print.printf("Average Degree: " + degree + "\r\r\n");
